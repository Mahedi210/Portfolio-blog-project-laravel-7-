        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{url('/main')}}">main</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseS" class="collapse" aria-labelledby="headingS" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{url('/Screate')}}">create</a>
                    <a class="collapse-item" href="{{url('/Slist')}}">list</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseP" class="collapse" aria-labelledby="headingP" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{url('/pcreate')}}">create</a>
                    <a class="collapse-item" href="{{url('/plist')}}">list</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseA" class="collapse" aria-labelledby="headingA" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{url('/acreate')}}">Create</a>
                    <a class="collapse-item" href="{{url('/alist')}}">List</a>
                </div>
            </div>
        </li>
