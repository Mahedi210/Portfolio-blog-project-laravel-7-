...
@section('content')
    <form action="{{url('/peditlist',$portfolio->id)}}" method="POST" enctype="multipart/form-data">
        @csrf

        <div class="row">
            <div class="form-group col-md-3 mt-3">
                <h3>Big Image</h3>
                <img style="height: 50vh"  src="{{url($portfolio->big_image)}}" class="img-thumbnail">
                <input class="mt-3" type="file"  name="big_image">

            </div>
            <div class="form-group col-md-3 mt-3">
                <h3>Small Image</h3>
                <img style="height: 50vh"  src="{{url($portfolio->small_image)}}" class="img-thumbnail">
